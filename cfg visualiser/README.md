...
The main executable is built from [ast.cpp](ast.cpp), and CMake defines the target name as `ast-tool`.
...
- [CMakeLists.txt](CMakeLists.txt): CMake configuration for the `ast-tool` executable
- [ast.cpp](ast.cpp): main Clang tool implementation
- [test.cpp](test.cpp): standalone scratch/example source file, not currently part of the CMake target
- [build/](build/): local build directory and generated artifacts
...
- [program_cfg.dot](build/program_cfg.dot)
- [graph.png](build/graph.png)
